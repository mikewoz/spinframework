...
DraggerTrackball::DraggerTrackball(bool useAutoTransform)
{
    if (useAutoTransform)
    {
...
DraggerTrackball::~DraggerTrackball()
{
}

void DraggerTrackball::setupDefaultGeometry()
{
    ...
    _xDragger->setColor(osg::Vec4(1.0f,0.0f,0.0f,0.5f));
    _yDragger->setColor(osg::Vec4(0.0f,1.0f,0.0f,0.5f));
    _zDragger->setColor(osg::Vec4(0.0f,0.0f,1.0f,0.5f));
