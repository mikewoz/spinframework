...
// *****************************************************************************
// constructor:
RayNodeIntersector::RayNodeIntersector (SceneManager *sceneManager, char *initID) : ReferencedNode(sceneManager, initID)
{
	
	this->setName(string(id->s_name) + ".RayNodeIntersector");
	nodeType = "RayNodeIntersector";
...
// *****************************************************************************
// destructor
RayNodeIntersector::~RayNodeIntersector()
{
...
void RayNodeIntersector::callbackUpdate()
{
	int i;
	...
	if (!parentNode.valid())
	{
		std::cout << "Error: RayNodeIntersector [" << this->id->s_name << "] must be attached to an RayNode node." << std::endl;
		return;
	}
...
/*
void RayNodeIntersector::getIntersections()
{
...
std::vector<lo_message> RayNodeIntersector::getState ()
{
