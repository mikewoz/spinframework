...
class UserNode : public ConstraintsNode
{
    ...
    public:
        ...
        */
        osg::PositionAttitudeTransform *getCameraAttachmentNode() const { return cameraAttachmentNode_.get(); }
        osg::PositionAttitudeTransform *getCameraOffsetNode() const { return cameraOffsetNode_.get(); }
        ...
        osg::Vec3 getCameraOffset() const { return cameraOffsetNode_->getPosition(); }
        ...
        osg::Quat getCameraOrientationQuat() const { return cameraAttachmentNode_->getAttitude(); }
